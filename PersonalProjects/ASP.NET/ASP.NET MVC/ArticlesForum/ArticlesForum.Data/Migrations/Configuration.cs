namespace ArticlesForum.Data.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<ArticlesForumDbContext>
    {
        ...
        {           //TODO Fix directory path error System.IO.DirectoryNotFoundException....
            ...
            var file = File.ReadAllBytes(directory + "/Migrations/Img/news.jpg");                         //(directory + "/Migrations/Img/news.jpg");("D:/MyProjects/Projects/PersonalProjects/ASP.NET/ASP.NET MVC/ArticlesForum/ArticlesForum.Data/Migrations/Img/news.jpg");
            var image = new Image
            {
                Content = file,
                FileExtension = "jpg"
